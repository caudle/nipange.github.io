...
part 'host_account_event.dart';
part 'host_account_state.dart';
part 'host_account_bloc.freezed.dart';

@injectable
class HostAccountBloc extends Bloc<HostAccountEvent, HostAccountState> {
  final IUserRepo iUserRepo;
  final IAuth iAuth;
  HostAccountBloc(this.iAuth, this.iUserRepo)
      : super(HostAccountState.initial());

  @override
  Stream<HostAccountState> mapEventToState(
    HostAccountEvent event,
  ) async* {
    yield* event.map(
      started: (e) async* {
