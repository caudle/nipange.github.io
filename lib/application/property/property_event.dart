...
class PropertyEvent with _$PropertyEvent {
  ...
  const factory PropertyEvent.typeChanged(String type) = _TypeChanged;
  ...
  const factory PropertyEvent.next(String? listingId) = _Next;
  const factory PropertyEvent.save(String? listingId) = _Save;
}
